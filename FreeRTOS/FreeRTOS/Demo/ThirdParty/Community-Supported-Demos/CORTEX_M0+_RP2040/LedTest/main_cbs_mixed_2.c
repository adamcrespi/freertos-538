/*
 * CBS Mixed Workload Test 2
 *
 * Two periodic EDF tasks + one independent CBS servers.
 ...
 *   Total U = 0.45 (schedulable)
 *
 * The CBS task does continuous work. Expected behavior:
